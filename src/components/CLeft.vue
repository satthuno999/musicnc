...
<template>
  <div class="left-nav-container rounded-l-3xl dark:bg-$dark_strong text-gray-500  dark:text-gray-400">
    <div class="p-6">
      ...
      <nav class="relative">
        <li>
          <a href="#"><i class="fas fa-record-vinyl"></i>Album</a>
        </li>
        <li>
          <a href="#"><i class="fas fa-folder"></i>Folders</a>
        </li>
        <li>
          <a href="#"><i class="far fa-compass"></i>Genres</a>
        </li>
      </nav>
      ...
      <nav class="relative">
        ...
        <ul>
          <li>
            <a href="#"><i class="fas fa-podcast"></i>Poscasts</a>
          </li>
          <li>
            <a href="#"><i class="fas fa-tower-cell"></i>Internet Radio</a>
          </li>
        </ul>
      </nav>
      ...
      <nav class="relative">
        ...
        <ul>
          ...
          <li>
            <a href="#"><i class="far fa-star"></i>Your Playlist</a>
          </li>
        </ul>
      </nav>
    </div>
