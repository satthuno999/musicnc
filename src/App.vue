...
<template>
    ...
    -->
	<div id="app" class="app-musicnc">
		<div class="bg-[#e9e9e9] dark:bg-[#888] px-[12%] py-5 min-h-screen grid justify-center items-center">
			<div
			...
			<div class="text-center text-xs text-gray-400 dark:text-gray-600">
				<p>
					...
					<a href="https://github.com/satthuno99/musicnc">satthuno99</a>.
					<a href="https://github.com/thuongtruong1009/musicnc/LICENSE">All rights reserved</a>!
				</p>
			</div>
		</div>
	</div>
