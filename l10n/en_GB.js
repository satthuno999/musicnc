OC.L10N.register(
  "audioplayer",
  {
    ...
    "Audio Player": "Music",
    "Add new tracks to playlist by drag and drop":
      "Add new tracks to playlist by drag and drop",
    ...
    "New or updated audio files available":
      "New or updated audio files available",
    ...
    Saved: "Saved",
    "Select a single folder with audio files":
      "Select a single folder with audio files",
    "Invalid path!": "Invalid path!",
    "All library entries will be deleted!":
      "All library entries will be deleted!",
    ...
    "Sorting Playlist success! Playlist reloaded!":
      "Sorting Playlist success! Playlist reloaded!",
    ...
    "Activate this setting if cyrillic characters are not recognized correctly. This makes the indexing slower!":
      "Activate this setting if cyrillic characters are not recognised correctly. This makes the indexing slower!",
