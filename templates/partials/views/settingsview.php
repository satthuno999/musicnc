<div class="view-container" id="music-user" ng-show="!loading">
	...
	<div>
		...
		<p><em translate>This setting specifies the folder which will be scanned for musicnc.</em></p>
	...
	<div ng-show="showAdmin">
		...
		<div>
			<p>musicnc.podcast_auto_update_interval</p>
			<p>
		...
		<div class="dimmed">
			<p>musicnc.allowed_radio_hls_src</p>
	...
	<div>
		<p>
			<img class="logotype" src="<?php \OCA\MusicNC\Utility\HtmlUtil::printSvgPath('music_logotype_horizontal') ?>" />
			<br/>
