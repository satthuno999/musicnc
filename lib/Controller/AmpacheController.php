...
use OCA\MusicNC\Middleware\AmpacheException;
...
class AmpacheController extends Controller {
	...
	private function createAmpacheActionUrl($action, $id, $auth, $type=null) {
		$api = $this->jsonMode ? 'musicnc.ampache.jsonApi' : 'musicnc.ampache.xmlApi';
