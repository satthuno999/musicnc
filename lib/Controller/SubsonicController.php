...
use OCA\MusicNC\AppFramework\BusinessLayer\BusinessLayerException;
use OCA\MusicNC\AppFramework\Core\Logger;
use OCA\MusicNC\AppFramework\Utility\MethodAnnotationReader;
use OCA\MusicNC\AppFramework\Utility\RequestParameterExtractor;
use OCA\MusicNC\AppFramework\Utility\RequestParameterExtractorException;
...
use OCA\MusicNC\Db\Album;
use OCA\MusicNC\Db\Artist;
use OCA\MusicNC\Db\Bookmark;
use OCA\MusicNC\Db\Genre;
use OCA\MusicNC\Db\MatchMode;
use OCA\MusicNC\Db\PodcastEpisode;
use OCA\MusicNC\Db\SortBy;
use OCA\MusicNC\Db\Track;

use OCA\MusicNC\Http\FileResponse;
use OCA\MusicNC\Http\FileStreamResponse;
use OCA\MusicNC\Http\XmlResponse;

use OCA\MusicNC\Middleware\SubsonicException;
...
use OCA\MusicNC\Utility\PlaceholderImage;
...
class SubsonicController extends Controller {
	...
	private function artistImageUrl(string $id) : string {
		...
		return $this->urlGenerator->linkToRouteAbsolute('musicnc.subsonic.handleRequest', ['method' => 'getCoverArt'])
