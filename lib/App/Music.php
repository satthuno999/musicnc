...
use OCA\MusicNC\BusinessLayer\AlbumBusinessLayer;
use OCA\MusicNC\BusinessLayer\ArtistBusinessLayer;
use OCA\MusicNC\BusinessLayer\BookmarkBusinessLayer;
use OCA\MusicNC\BusinessLayer\GenreBusinessLayer;
use OCA\MusicNC\BusinessLayer\Library;
use OCA\MusicNC\BusinessLayer\PlaylistBusinessLayer;
use OCA\MusicNC\BusinessLayer\PodcastChannelBusinessLayer;
use OCA\MusicNC\BusinessLayer\PodcastEpisodeBusinessLayer;
use OCA\MusicNC\BusinessLayer\RadioStationBusinessLayer;
use OCA\MusicNC\BusinessLayer\TrackBusinessLayer;

use OCA\MusicNC\Controller\AmpacheController;
use OCA\MusicNC\Controller\ApiController;
use OCA\MusicNC\Controller\LogController;
use OCA\MusicNC\Controller\PageController;
use OCA\MusicNC\Controller\PlaylistApiController;
use OCA\MusicNC\Controller\PodcastApiController;
use OCA\MusicNC\Controller\RadioApiController;
use OCA\MusicNC\Controller\SettingController;
use OCA\MusicNC\Controller\ShareController;
use OCA\MusicNC\Controller\ShivaApiController;
use OCA\MusicNC\Controller\SubsonicController;

use OCA\MusicNC\Db\AlbumMapper;
use OCA\MusicNC\Db\AmpacheSessionMapper;
use OCA\MusicNC\Db\AmpacheUserMapper;
use OCA\MusicNC\Db\ArtistMapper;
use OCA\MusicNC\Db\BookmarkMapper;
use OCA\MusicNC\Db\Cache;
use OCA\MusicNC\Db\GenreMapper;
use OCA\MusicNC\Db\Maintenance;
use OCA\MusicNC\Db\PlaylistMapper;
use OCA\MusicNC\Db\PodcastChannelMapper;
use OCA\MusicNC\Db\PodcastEpisodeMapper;
use OCA\MusicNC\Db\RadioStationMapper;
use OCA\MusicNC\Db\TrackMapper;

use OCA\MusicNC\Hooks\FileHooks;
use OCA\MusicNC\Hooks\ShareHooks;
use OCA\MusicNC\Hooks\UserHooks;

use OCA\MusicNC\Middleware\AmpacheMiddleware;
use OCA\MusicNC\Middleware\SubsonicMiddleware;

use OCA\MusicNC\Utility\AmpacheUser;
use OCA\MusicNC\Utility\CollectionHelper;
use OCA\MusicNC\Utility\CoverHelper;
use OCA\MusicNC\Utility\DetailsHelper;
use OCA\MusicNC\Utility\ExtractorGetID3;
use OCA\MusicNC\Utility\LastfmService;
use OCA\MusicNC\Utility\PlaylistFileService;
use OCA\MusicNC\Utility\PodcastService;
use OCA\MusicNC\Utility\RadioService;
use OCA\MusicNC\Utility\Random;
use OCA\MusicNC\Utility\Scanner;
use OCA\MusicNC\Utility\LibrarySettings;

class Music extends App {
	public function __construct(array $urlParams=[]) {
		parent::__construct('Musicnc', $urlParams);

		\mb_internal_encoding('UTF-8');

		if (!\class_exists('OCA\MusicNC\AppFramework\Db\CompatibleMapper')) {
			if (\class_exists(\OCP\AppFramework\Db\Mapper::class)) {
				\class_alias(\OCP\AppFramework\Db\Mapper::class, 'OCA\MusicNC\AppFramework\Db\CompatibleMapper');
			} else {
