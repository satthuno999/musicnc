 ...
 * \OCA\MusicNC\Db\Cache. The actual json data is stored in the former and a hash of the data
 ...
 * the database configuration, the json data may be too large to store it to \OCA\MusicNC\Db\Cache
