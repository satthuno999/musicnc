...
use OCA\MusicNC\Db\PodcastChannel;
...
class CoverHelper {
	...
	public function __construct(
		...
		$this->coverSize = \intval($config->getSystemValue('musicnc.cover_size')) ?: 380;
	}
	 ...
	 * @return array|null Image data in format accepted by \OCA\MusicNC\Http\FileResponse
	 */
	 ...
	 * @param array $image The image to be scaled down in format accepted by \OCA\MusicNC\Http\FileResponse
	 * @param integer $maxSize The maximum size in pixels for the square shaped output
	 * @return array The processed image in format accepted by \OCA\MusicNC\Http\FileResponse
	 */
