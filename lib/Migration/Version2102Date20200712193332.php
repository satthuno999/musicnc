...
class Version2102Date20200712193332 extends SimpleMigrationStep {
    ...
    public function changeSchema(IOutput $output, Closure $schemaClosure, array $options) {
        ...
        if (!$schema->hasTable('musicnc_artists')) {
            $table = $schema->createTable('musicnc_artists');
        ...
        if (!$schema->hasTable('musicnc_albums')) {
            $table = $schema->createTable('musicnc_albums');
            $table->addColumn('id', 'integer', [
                'autoincrement' => true,
                'notnull' => true,
                'unsigned' => true,
        ...
        if (!$schema->hasTable('musicnc_genre')) {
            $table = $schema->createTable('musicnc_genre');
            $table->addColumn('id', 'integer', [
                'autoincrement' => true,
                'notnull' => true,
                'unsigned' => true,
        ...
        if (!$schema->hasTable('musicnc_playlists')) {
            $table = $schema->createTable('musicnc_playlists');
            $table->addColumn('id', 'integer', [
                'autoincrement' => true,
                'notnull' => true,
                'unsigned' => true,
        ...
        if (!$schema->hasTable('musicnc_playlist_tracks')) {
            $table = $schema->createTable('musicnc_playlist_tracks');
        ...
        if (!$schema->hasTable('musicnc_tracks')) {
            $table = $schema->createTable('musicnc_tracks');
            $table->addColumn('id', 'integer', [
                'autoincrement' => true,
                'notnull' => true,
                'unsigned' => true,
        ...
        if (!$schema->hasTable('musicnc_streams')) {
            $table = $schema->createTable('musicnc_streams');
            $table->addColumn('id', 'integer', [
                'autoincrement' => true,
                'notnull' => true,
                'unsigned' => true,
        ...
        if (!$schema->hasTable('musicnc_stats')) {
            $table = $schema->createTable('musicnc_stats');
            $table->addColumn('id', 'integer', [
                'autoincrement' => true,
                'notnull' => true,
                'unsigned' => true,
