...
angular.module('Musicnc').controller('PodcastDetailsController', [
	...
	function ($rootScope, $scope, Restangular, gettextCatalog, libraryService) {
		...
		$scope.formatValue = function(key, value) {
			...
			case 'duration':		return OCA.musicnc.Utils.formatPlayTime(value);
			case 'size':			return OCA.musicnc.Utils.formatFileSize(value);
			case 'bit_rate':		return OCA.musicnc.Utils.formatBitrate(value);
			case 'published':		// fall through
			case 'last_build_date':	// fall through
			case 'update_checked':	return OCA.musicnc.Utils.formatDateTime(value);
