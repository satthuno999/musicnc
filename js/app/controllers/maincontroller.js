...
angular.module('Musicnc').controller('MainController', [
...
function ($rootScope, $scope, $timeout, $window, $document, ArtistFactory, 
	...
	OCA.musicnc.DarkThemeLegacySupport.applyOnElement(document.getElementById('app'));
	...
	function showDetails(entityType, id) {
		var capType = OCA.musicnc.Utils.capitalize(entityType);
	...
	function scrollOffset() {
		...
		if (OCA.musicnc.Utils.getScrollContainer()[0] !== document.getElementById('app-content')) {
	...
	$scope.scrollToItem = function(itemId, animationTime /* optional */) {
		if (itemId) {
			var container = OCA.musicnc.Utils.getScrollContainer();
			var element = $('#' + itemId);
	...
	$scope.scrollToTop = function() {
		OCA.musicnc.Utils.getScrollContainer().scrollTo(0, 0);
	};
	...
	if (OCA.musicnc.Utils.isLegacyLayout()) {
