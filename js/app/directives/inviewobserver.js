 ...
 */
angular.module('Musicnc').directive('inViewObserver', ['$rootScope', '$timeout', 'inViewService',
function($rootScope, $timeout, inViewService) {
	...
	OCA.musicnc.Utils.getScrollContainer()[0].addEventListener('scroll', throttledOnScroll);
