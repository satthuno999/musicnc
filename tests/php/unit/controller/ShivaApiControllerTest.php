...
class ShivaApiControllerTest extends ControllerTestUtility {
	...
	public static function linkToRouteMock(string $route, array $args) : string {
		switch ($route) {
			case 'musicnc.shivaApi.artist':	return "/link/to/artist/{$args['artistId']}";
			case 'musicnc.shivaApi.album':	return "/link/to/album/{$args['albumId']}";
			case 'musicnc.shivaApi.track':	return "/link/to/track/{$args['trackId']}";
			case 'musicnc.api.download':		return "/link/to/file/{$args['fileId']}";
			case 'musicnc.api.artistCover':	return "/link/to/artist/cover/{$args['artistId']}";
			case 'musicnc.api.albumCover':	return "/link/to/album/cover/{$args['albumId']}";
